...
// Variables
const rootDomain = "mahatanfoolvpn.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "mahatanfoolvpn"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>MahatanFoolVPN</span>");
